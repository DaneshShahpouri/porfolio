...
export default {
    ...
    methods: {
        ...
        getImpProjects() {
            this.prevProjects = this.store.projectsServe;
            let newConf = [];
        ...
        <div class="_container-wrapper">
            ...
            <div v-else class="__container p-center 'justify-content-center align-items-center p-0" id="container-1">
                <div class="container img-wrapper">
                    <img :src="'/assets/Projects/' + store.confArray[store.contatore][3][store.contatoreOrizzontale]"
                        alt="prova">
                </div>
            </div>
            ...
            <div v-if="this.store.confArray[this.store.contatore][3]">
                <div v-if="this.precontatoreOrizzontale > 0"
                    ...
                    <div class="container img-wrapper">
                        <img :src="'/assets/Projects/' + this.store.confArray[this.store.contatore][3][this.precontatoreOrizzontale]"
                            alt="prova">
                    </div>
                </div>
            ...
            <div v-if="this.store.confArray[this.store.contatore][3]"
                ...
                <div class="container img-wrapper">
                    <img :src="'/assets/Projects/' + this.store.confArray[this.store.contatore][3][this.postcontatoreOrizzontale]"
                        alt="prova">
                </div>
            </div>
            ...
            <div class="background" id="background">
                ...
                <div class="cerchio bottom-showroom" id="cerchio-bottom">
                    ...
                    <img id="img-bg"
                        :src="this.store.confArray[this.store.contatore][3] ? '/assets/Projects/' + this.store.confArray[this.store.contatore][3][1] : ''"
