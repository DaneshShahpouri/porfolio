...
export default {
    ...
    methods: {
        ...
        getTempProjects() {
            ...
            this.store.projectsServe.forEach(project => {
                if (this.store.searchInput != '') {
            ...
            <div class="container d-flex justify-content-start align-item-center flex-column _cards-container">
                ...
                <div class="_mycard" v-for="project in this.store.projects">
                    ...
                    <div class="img-wrapper">
                        <img :src="project.cover_image == null ? 'https://www.kuleuven.be/communicatie/congresbureau/fotos-en-afbeeldingen/no-image.png/image' : '/assets/Projects/' + project.cover_image"
